<script lang="ts">
	...
	// Taken from https://www.skeleton.dev/utilities/codeblocks
	// Event Dispatcher
	type CodeBlockEvent = {
		copy: never;
	};
	...
	const cHeader =
		"text-xs text-white/50 uppercase flex justify-between items-center p-2 pl-4";
...
<!-- prettier-ignore -->
{#if language && code}
<div class="codeblock {classesBase} {twClasses}" data-testid="codeblock">
	<!-- Header -->
